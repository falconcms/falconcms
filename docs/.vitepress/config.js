      ...
      '/changelog': [
        {
          text: 'Changelog',
          items: [
            { text: 'v1.3.30 (Latest)', link: '/changelog#v1-3-30' },
            { text: 'v1.3.29', link: '/changelog#v1-3-29' },
            { text: 'v1.3.28', link: '/changelog#v1-3-28' },
            { text: 'v1.3.27', link: '/changelog#v1-3-27' },
            { text: 'v1.3.26', link: '/changelog#v1-3-26' },
            { text: 'v1.3.25', link: '/changelog#v1-3-25' },
            { text: 'v1.3.24', link: '/changelog#v1-3-24' },
            { text: 'v1.3.23', link: '/changelog#v1-3-23' },
            { text: 'v1.3.22', link: '/changelog#v1-3-22' },
            { text: 'v1.3.21', link: '/changelog#v1-3-21' },
            { text: 'v1.3.20', link: '/changelog#v1-3-20' },
            { text: 'v1.3.19', link: '/changelog#v1-3-19' },
            { text: 'v1.3.18', link: '/changelog#v1-3-18' },
            { text: 'v1.3.17', link: '/changelog#v1-3-17' },
            { text: 'v1.3.16', link: '/changelog#v1-3-16' },
            { text: 'v1.3.15', link: '/changelog#v1-3-15' },
            { text: 'v1.3.14', link: '/changelog#v1-3-14' },
            { text: 'v1.3.13', link: '/changelog#v1-3-13' },
            { text: 'v1.3.12', link: '/changelog#v1-3-12' },
            { text: 'v1.3.11', link: '/changelog#v1-3-11' },
            { text: 'v1.3.10', link: '/changelog#v1-3-10' },
            { text: 'v1.3.9', link: '/changelog#v1-3-9' },
            { text: 'v1.3.4', link: '/changelog#v1-3-4' },
            { text: 'v1.3.3', link: '/changelog#v1-3-3' },
