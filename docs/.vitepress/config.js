      ...
      '/changelog': [
        {
          text: 'Changelog',
          items: [
            { text: 'v2.6.13 (Latest)', link: '/changelog#v2-6-13' },
            { text: 'v2.6.12', link: '/changelog#v2-6-12' },
            { text: 'v2.6.11', link: '/changelog#v2-6-11' },
            { text: 'v2.6.10', link: '/changelog#v2-6-10' },
            { text: 'v2.6.9', link: '/changelog#v2-6-9' },
            { text: 'v2.6.8', link: '/changelog#v2-6-8' },
            { text: 'v2.6.7', link: '/changelog#v2-6-7' },
            { text: 'v2.6.6', link: '/changelog#v2-6-6' },
            { text: 'v2.6.5', link: '/changelog#v2-6-5' },
            { text: 'v2.6.4', link: '/changelog#v2-6-4' },
            { text: 'v2.6.3', link: '/changelog#v2-6-3' },
