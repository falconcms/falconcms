...
class UserAgentParser
{
    ...
    public static function device(?string $ua): string
    {
        ...
        if (preg_match('/ipad|playbook|silk|tablet|kindle|(android(?!.*mobile))/i', $ua)) {
            return 'tablet';
        }

        if (preg_match('/mobile|iphone|ipod|windows phone|blackberry|bb10|opera mini|iemobile|webos/i', $ua)) {
            return 'mobile';
        }
