    ...
    <div class="container-custom">
        ...
        @if(empty($cart))
            <div class="py-20 text-center border border-dashed border-gray-200 rounded">
                ...
                <a href="{{ get_falcon_shop_url() }}" class="inline-block bg-primary text-white px-8 py-3 rounded-sm font-bold hover:opacity-90 hover:text-white transition-all uppercase text-sm">Return to shop</a>
            </div>
        @else
            ...
            <div class="flex flex-col md:flex-row justify-end">
                <div class="w-full md:w-[450px]">
                    ...
                    <a href="{{ get_falcon_checkout_url() }}" class="block w-full bg-primary text-white text-center py-4 font-bold rounded-sm hover:opacity-90 hover:text-white transition-all uppercase shadow-md shadow-primary/20">Proceed to checkout</a>
                </div>
            </div>
