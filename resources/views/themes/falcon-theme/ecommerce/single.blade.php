            ...
            <div class="w-full md:w-1/2 flex flex-col justify-center">
                ...
                <?php
                    $productTitleHtml = '<h1 class="text-3xl md:text-4xl font-bold text-heading mb-4">'
                        . e($post->title) . '</h1>';
                    $productTitleHtml = apply_falcon_filters('lazy_simple_product_title', $productTitleHtml, $post);
                ...
                <?php
                    ...
                    $priceHtml = apply_falcon_filters('lazy_simple_product_price', $priceHtml, $post);
                    echo $priceHtml;
                ?>
                ...
                <?php
                    ...
                    $shortDescHtml = apply_falcon_filters('lazy_simple_short_description', $shortDescHtml, $post);
                    echo $shortDescHtml;
                ?>
                @endif
                    ...
                    <form action="{{ route('shop.cart.add') }}" method="POST" class="mb-10 border-b border-gray-100 pb-10" id="lazy-add-to-cart-form">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <?php
                                ...
                                $btnHtml = apply_falcon_filters('lazy_simple_add_to_cart_button', $btnHtml, $post);
                                echo $btnHtml;
                            ?>
