...
<?php do_falcon_action('falcon_variable_before_single_product', $post); ?>
    ...
    <div class="container-custom">
        ...
        <div class="flex flex-col lg:flex-row gap-12 mb-20">
            ...
            <div class="w-full lg:w-1/2 flex flex-col">
                <?php do_falcon_action('falcon_variable_before_product_title', $post); ?>
                {!! apply_falcon_filters('falcon_variable_product_title', '<h1 class="text-[36px] font-bold text-[#2c3338] mb-4 leading-tight">' . e($post->title) . '</h1>', $post) !!}
                <?php do_falcon_action('falcon_variable_after_product_title', $post); ?>
                
                <?php do_falcon_action('falcon_variable_before_product_price', $post); ?>
                ...
                @if($post->shopData && !empty($post->shopData->sale_ends_at) && \Carbon\Carbon::parse($post->shopData->sale_ends_at)->isFuture())
                ...
                {!! apply_falcon_filters('falcon_variable_short_description', '<div class="text-[15px] text-gray-600 mb-8 leading-relaxed">' . $post->shopData->short_description . '</div>', $post) !!}
                @endif
                <?php do_falcon_action('falcon_variable_after_short_description', $post); ?>
                ...
                <?php do_falcon_action('falcon_variable_before_add_to_cart_form', $post); ?>
                <div class="space-y-6 pt-6 border-t border-gray-100 mb-10 pb-8 border-b border-gray-100">
                    <form id="add-to-cart-form" action="{{ route('shop.cart.add') }}" method="POST" class="w-full">
                        ...
                        <?php do_falcon_action('falcon_variable_add_to_cart_form_top', $post); ?>
                        <?php falcon_render_product_fields(apply_falcon_filters('falcon_variable_product_fields', apply_falcon_filters('falcon_product_fields', [], $post), $post)); ?>
                        ...
                        <div class="flex items-center gap-3 w-full mt-4">
                            ...
                            <?php do_falcon_action('falcon_variable_before_add_to_cart_button', $post); ?>
                            {!! apply_falcon_filters('falcon_variable_add_to_cart_button',
                                ...
                                $post) !!}
                            <?php do_falcon_action('falcon_variable_after_add_to_cart_button', $post); ?>
                        ...
                        <?php do_falcon_action('falcon_variable_add_to_cart_form_bottom', $post); ?>
                    </form>
                </div>
                <?php do_falcon_action('falcon_variable_after_add_to_cart_form', $post); ?>
                ...
                <div class="text-[13px] text-gray-500 space-y-3 mt-6">
                    ...
                    <?php do_falcon_action('falcon_variable_product_meta_fields', $post); ?>
                </div>
                <?php do_falcon_action('falcon_variable_after_product_meta', $post); ?>
            </div>
        </div>
...
<?php do_falcon_action('falcon_variable_after_single_product', $post); ?>
