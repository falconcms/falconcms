...
<div class="wrapper">
    <div class="container">
        ...
        <div class="header">
            ...
            @endif
            <p class="header-tagline">Confirm Your Email</p>
        </div>
        ...
        <div class="body">
            ...
            <p class="text">
                ...
                Click the button below to verify — you won't be able to sign in until your email is confirmed.
            </p>
            ...
            <div class="expiry-box">
                ⏳ <strong>This link expires in {{ $expiresMinutes }} minutes.</strong> If it expires, you can request a new one from the sign-in page.
            </div>

            <p class="text">
                If you did not create an account, you can safely ignore this email — no account will be activated.
            </p>

            <hr class="divider">

            <p class="link-fallback">Button not working? Copy and paste this link into your browser:</p>
        ...
        <div class="footer">
            <p class="footer-text">
                &copy; {{ date('Y') }} <a href="{{ $siteUrl }}" class="footer-link">{{ $siteName }}</a>. All rights reserved.
            </p>
        </div>
    </div>
</div>
