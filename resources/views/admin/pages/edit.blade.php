                    ...
                    <div class="wp-metabox-content" style="padding: 10px;">
                        ...
                        <div class="text-[13px] text-[#646970] space-y-3 mb-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex-grow">
                                    <span id="publish-display-prefix">{{ $page->status == 'scheduled' ? 'Scheduled for' : 'Published on' }}</span> <strong class="text-black" id="publish-display-text">{{ $page->published_at ? $page->published_at->format('M j, Y @ H:i') : $page->created_at?->format('M j, Y @ H:i') }}</strong> <a href="#" class="text-[#2271b1] underline ml-1 toggle-publish-edit" data-target="publish-edit">Edit</a>
                                    <div id="publish-edit" class="hidden mt-2 p-2 bg-[#f6f7f7] border border-[#dfdfdf]">
                                        <div class="flex flex-wrap items-center gap-1 mb-2 text-[12px]">
                                            @php 
                                                ...
                                                $pDate = $page->published_at ?: $page->created_at ?: now();
                                            @endphp
