    ...
    <div class="max-w-4xl bg-white border border-[#c3c4c7] p-5">
        <form action="{{ route('admin.tags.update', $tag) }}" method="POST">
                    ...
                    <td class="py-4 px-2">
                        ...
                        @elseif($tag->origin_id)
                            <div class="mt-2 text-[12px] text-[#646970]">
                                ...
                                <a href="{{ route('admin.tags.edit', $tag->origin_id) }}" class="text-[#2271b1] underline">the original tag</a>.
                            </div>
                        @endif
                    </td>
                </tr>
            ...
            <div class="mt-6 flex items-center space-x-4">
                ...
                <a href="{{ route('admin.tags.index') }}" class="text-[#2271b1] text-[13px] underline">Back to Tags</a>
            </div>
        </form>
    </div>
