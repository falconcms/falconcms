<x-falcon-cms::layouts.admin title="Tags">
    <x-falcon-cms::admin.delete-modal />
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-[23px] font-normal text-[#1d2327]">Tags</h1>    </div>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="w-full md:w-2/3">
            <div class="flex justify-end mb-2">
                <form action="{{ route('admin.tags.index') }}" method="GET" class="flex space-x-1">
                        ...
                        <tr class="{{ $idx % 2 === 0 ? 'bg-[#f6f7f7]' : 'bg-[#fff]' }} group">
                            ...
                            <td class="wp-table-cell align-top">
                                ...
                                <div class="invisible group-hover:visible mt-1 text-[13px] space-x-1">
                                    ...
                                    <a href="{{ url('tag/' . $tag->slug) }}" target="_blank" class="text-[#2271b1]">View</a>
                                </div>
                            </td>
            ...
            @foreach($tags as $tag)
                <form id="delete-form-{{ $tag->id }}" action="{{ route('admin.tags.destroy', $tag) }}" method="POST" class="hidden">
                    @csrf @method('DELETE')
                </form>
            @endforeach
        </div>
