...
<div class="h-full flex flex-col bg-white">
    ...
    <div class="flex bg-[#0091ea]">
        ...
        <button @click="activeColPanelTab = 'extra'"
                :class="activeColPanelTab === 'extra' ? 'bg-[#007cc0] text-white' : 'text-white/70 hover:text-white'"
                class="flex-1 py-2 text-[11px] font-bold transition-all flex items-center justify-center gap-1">
            <i class="fa fa-cog"></i>
            ...
            <div>
                    ...
                    <div class="flex gap-1 items-center">
                        ...
                        <div class="relative inline-block">
                            ...
                            <div v-show="activeResponsiveMenu === 'colAlignment'" class="absolute right-0 mt-1 bg-white border border-slate-200 rounded shadow-lg z-50 flex gap-0.5 p-1 min-w-max">
                                <button @click="device = 'desktop'; activeResponsiveMenu = null" :class="device === 'desktop' ? 'bg-[#0091ea] text-white' : 'text-slate-600 hover:bg-slate-100'" class="w-6 h-6 rounded text-[10px] flex items-center justify-center transition-all"><i class="fa fa-desktop text-[11px]"></i></button>
                                <button @click="device = 'tablet'; activeResponsiveMenu = null" :class="device === 'tablet' ? 'bg-[#0091ea] text-white' : 'text-slate-600 hover:bg-slate-100'" class="w-6 h-6 rounded text-[10px] flex items-center justify-center transition-all"><i class="fa fa-tablet-alt text-[11px]"></i></button>
                                <button @click="device = 'mobile'; activeResponsiveMenu = null" :class="device === 'mobile' ? 'bg-[#0091ea] text-white' : 'text-slate-600 hover:bg-slate-100'" class="w-6 h-6 rounded text-[10px] flex items-center justify-center transition-all"><i class="fa fa-mobile-alt text-[11px]"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-5 gap-1">
                    <button @click="setResponsiveVal(editingColumn.settings, 'alignment', device, 'default')"
                            :class="(!getResponsiveVal(editingColumn.settings, 'alignment', device) || getResponsiveVal(editingColumn.settings, 'alignment', device) === 'default') ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'alignment', device, 'flex-start')"
                            :class="getResponsiveVal(editingColumn.settings, 'alignment', device) === 'flex-start' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'alignment', device, 'center')"
                            :class="getResponsiveVal(editingColumn.settings, 'alignment', device) === 'center' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'alignment', device, 'flex-end')"
                            :class="getResponsiveVal(editingColumn.settings, 'alignment', device) === 'flex-end' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'alignment', device, 'stretch')"
                            :class="getResponsiveVal(editingColumn.settings, 'alignment', device) === 'stretch' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-2">
                    <button @click="editingColumn.settings.contentLayout = 'column'"
                            :class="editingColumn.settings.contentLayout === 'column' || !editingColumn.settings.contentLayout ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                    ...
                    <button @click="editingColumn.settings.contentLayout = 'row'"
                            :class="editingColumn.settings.contentLayout === 'row' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                    ...
                    <button @click="editingColumn.settings.contentLayout = 'block'"
                            :class="editingColumn.settings.contentLayout === 'block' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
            ...
            <div v-if="editingColumn.settings.contentLayout === 'column' || !editingColumn.settings.contentLayout">
                ...
                <div class="grid grid-cols-3 gap-2 mb-2">
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignH', device, 'flex-start')"
                            :class="(!getResponsiveVal(editingColumn.settings, 'contentAlignH', device) || getResponsiveVal(editingColumn.settings, 'contentAlignH', device) === 'flex-start') ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignH', device, 'center')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignH', device) === 'center' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignH', device, 'flex-end')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignH', device) === 'flex-end' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                ...
                <div class="grid grid-cols-3 gap-2 mb-2">
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignV', device, 'flex-start')"
                            :class="(!getResponsiveVal(editingColumn.settings, 'contentAlignV', device) || getResponsiveVal(editingColumn.settings, 'contentAlignV', device) === 'flex-start') ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignV', device, 'center')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignV', device) === 'center' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignV', device, 'flex-end')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignV', device) === 'flex-end' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                ...
                <div class="grid grid-cols-3 gap-2">
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignV', device, 'space-between')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignV', device) === 'space-between' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignV', device, 'space-around')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignV', device) === 'space-around' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignV', device, 'space-evenly')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignV', device) === 'space-evenly' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
            ...
            <div v-if="editingColumn.settings.contentLayout === 'row'">
                ...
                <div class="grid grid-cols-3 gap-2 mb-4">
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignH', device, 'space-between')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignH', device) === 'space-between' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignH', device, 'space-around')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignH', device) === 'space-around' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignH', device, 'space-evenly')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignH', device) === 'space-evenly' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <button @click="setResponsiveVal(editingColumn.settings, 'contentAlignV', device, 'stretch')"
                            :class="getResponsiveVal(editingColumn.settings, 'contentAlignV', device) === 'stretch' ? 'bg-[#0091ea] text-white' : 'bg-slate-100 text-slate-400 hover:bg-slate-200'"
                            class="py-2 rounded transition-colors flex items-center justify-center relative group/btn">
            ...
            <div>
                ...
                <div class="grid grid-cols-5 gap-1 mb-3">
                    <button v-for="w in ['16.66%', '20%', '25%', '33.33%', '40%', '50%', '60%', '66.66%', '75%', '80%', '83.33%', '100%', 'auto']"
                            @click="updateBasis(w)"
                            :class="(device === 'desktop' ? editingColumn.basis : (editingColumn['basis_' + device] || editingColumn.basis)) === w ? 'bg-[#0091ea] text-white' : 'bg-slate-50 text-slate-400 border-slate-100'"
            ...
            <div class="pt-4 border-t border-slate-50 space-y-4">
                ...
                <template v-if="getResponsiveVal(editingColumn.settings, 'boxShadow', device)">
                    ...
                    <div>
                        ...
                        <div class="flex bg-slate-100 rounded p-0.5">
                            <button @click="setResponsiveVal(editingColumn.settings, 'boxShadowStyle', device, 'outer')" :class="(getResponsiveVal(editingColumn.settings, 'boxShadowStyle', device) || 'outer') === 'outer' ? 'bg-[#0091ea] text-white shadow-sm' : 'text-slate-400'" class="flex-1 py-1 text-[10px] font-bold rounded transition-all">Outer</button>
                            <button @click="setResponsiveVal(editingColumn.settings, 'boxShadowStyle', device, 'inner')" :class="getResponsiveVal(editingColumn.settings, 'boxShadowStyle', device) === 'inner' ? 'bg-[#0091ea] text-white shadow-sm' : 'text-slate-400'" class="flex-1 py-1 text-[10px] font-bold rounded transition-all">Inner</button>
                        </div>
                    </div>
                </template>
            </div>
                ...
                <div v-show="editingColumn.settings.bgType === 'gradient'" class="space-y-4 border border-slate-100 rounded-md p-2">
                    ...
                    <div class="border-b border-slate-100 pb-3">
                        ...
                        <div class="flex gap-2 items-center">
                            ...
                            <input type="range" min="0" max="100" v-model="editingColumn.settings.bgGradientStartPosition" class="flex-1 h-1 bg-[#0091ea] rounded appearance-none cursor-pointer">
                        </div>
                    </div>
                    ...
                    <div class="border-b border-slate-100 pb-3">
                        ...
                        <div class="flex gap-2 items-center">
                            ...
                            <input type="range" min="0" max="100" v-model="editingColumn.settings.bgGradientEndPosition" class="flex-1 h-1 bg-[#0091ea] rounded appearance-none cursor-pointer">
                        </div>
                    </div>
                    ...
                    <div class="border-b border-slate-100 pb-3">
                        ...
                        <div class="flex bg-slate-100 rounded overflow-hidden">
                            <button @click="editingColumn.settings.bgGradientType = 'linear'" 
                                    :class="editingColumn.settings.bgGradientType === 'linear' ? 'bg-[#0091ea] text-white' : 'text-slate-500 hover:bg-slate-200'"
                            ...
                            <button @click="editingColumn.settings.bgGradientType = 'radial'" 
                                    :class="editingColumn.settings.bgGradientType === 'radial' ? 'bg-[#0091ea] text-white' : 'text-slate-500 hover:bg-slate-200'"
                    ...
                    <div v-show="editingColumn.settings.bgGradientType === 'linear'">
                        ...
                        <div class="flex gap-2 items-center">
                            ...
                            <input type="range" min="0" max="360" v-model="editingColumn.settings.bgGradientAngle" class="flex-1 h-1 bg-[#0091ea] rounded appearance-none cursor-pointer">
                        </div>
                    </div>
                </div>
                                ...
                                <div class="flex gap-1 items-center">
                                    ...
                                    <div class="relative inline-block">
                                        ...
                                        <div v-show="activeResponsiveMenu === 'colBgPos'" class="absolute right-0 mt-1 bg-white border border-slate-200 rounded shadow-lg z-50 flex gap-0.5 p-1 min-w-max">
                                            <button @click="device = 'desktop'; activeResponsiveMenu = null" :class="device === 'desktop' ? 'bg-[#0091ea] text-white shadow-xs' : 'text-slate-600 hover:bg-slate-100'" class="w-6 h-6 rounded text-[10px] flex items-center justify-center transition-all" title="Desktop"><i class="fa fa-desktop text-[11px]"></i></button>
                                            <button @click="device = 'tablet'; activeResponsiveMenu = null" :class="device === 'tablet' ? 'bg-[#0091ea] text-white shadow-xs' : 'text-slate-600 hover:bg-slate-100'" class="w-6 h-6 rounded text-[10px] flex items-center justify-center transition-all" title="Tablet"><i class="fa fa-tablet-alt text-[11px]"></i></button>
                                            <button @click="device = 'mobile'; activeResponsiveMenu = null" :class="device === 'mobile' ? 'bg-[#0091ea] text-white shadow-xs' : 'text-slate-600 hover:bg-slate-100'" class="w-6 h-6 rounded text-[10px] flex items-center justify-center transition-all" title="Mobile"><i class="fa fa-mobile-alt text-[11px]"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="flex gap-1">
                            <button @click="editingColumn.settings.stickyDesktop = editingColumn.settings.stickyDesktop === false ? true : false"
                                    :class="editingColumn.settings.stickyDesktop !== false ? 'bg-[#0091ea] text-white' : 'bg-slate-200 text-slate-400'"
                            ...
                            <button @click="editingColumn.settings.stickyTablet = editingColumn.settings.stickyTablet === false ? true : false"
                                    :class="editingColumn.settings.stickyTablet !== false ? 'bg-[#0091ea] text-white' : 'bg-slate-200 text-slate-400'"
                                    class="flex-1 py-1 rounded text-[10px] font-medium transition-colors flex items-center justify-center gap-1">
                            ...
                            <button @click="editingColumn.settings.stickyMobile = editingColumn.settings.stickyMobile === false ? true : false"
                                    :class="editingColumn.settings.stickyMobile !== false ? 'bg-[#0091ea] text-white' : 'bg-slate-200 text-slate-400'"
                                    class="flex-1 py-1 rounded text-[10px] font-medium transition-colors flex items-center justify-center gap-1">
