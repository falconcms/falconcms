    ...
    <div class="max-w-4xl bg-white border border-[#c3c4c7] p-5">
        <form action="{{ route('admin.product-tags.update', $tag) }}" method="POST">
            ...
            <table class="w-full text-[14px]">
                ...
                <tr class="align-top border-b border-[#f0f0f1]">
                    ...
                    <td class="py-4 px-2">
                        ...
                        @elseif($tag->origin_id)
                            <div class="mt-2 text-[12px] text-[#646970]">
                                This is a translation of 
                                <a href="{{ route('admin.product-tags.edit', $tag->origin_id) }}" class="text-[#2271b1] underline">the original tag</a>.
                            </div>
                        @endif
                    </td>
                </tr>
                ...
                <tr class="align-top border-b border-[#f0f0f1]">
                    ...
                    <td class="py-4 px-2">
                        <input type="text" name="slug" value="{{ old('slug', $tag->slug) }}" class="wp-input w-full max-w-[400px]">
                ...
                <tr class="align-top">
                    ...
                    <td class="py-4 px-2">
                        <textarea name="description" rows="5" class="wp-input w-full max-w-[400px]">{{ old('description', $tag->description) }}</textarea>
            ...
            <div class="mt-6 flex items-center space-x-4">
                ...
                <a href="{{ route('admin.product-tags.index') }}" class="text-[#2271b1] text-[13px] underline">Back to Tags</a>
            </div>
        </form>
    </div>
