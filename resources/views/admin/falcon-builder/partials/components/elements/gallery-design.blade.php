<div class="space-y-5">
    ...
    <div class="border-t border-slate-50 pt-4 space-y-4" v-if="(editingElement.settings.images || []).some(img => img.caption)">
        ...
        <div>
            ...
            <font-select v-model="editingElement.settings.captionFontFamily" @change="loadBuilderFont($event)" :font-groups="builderFontGroups" :theme-font="themeBodyFont"></font-select>
        </div>
