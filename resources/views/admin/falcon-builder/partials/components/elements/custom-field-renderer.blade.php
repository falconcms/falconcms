...
<div>
    ...
    <template v-if="editingElement.settings.{{ $dynKey }}">
        <div class="mb-2">
            @include('falcon-cms::admin.falcon-builder.partials.components.elements.custom-dynamic-select', ['dynKey' => $dynKey, 'dynCtx' => 'text'])
        </div>
    </template>
...
<div>
    <div class="flex justify-between items-center mb-3">
        ...
        @if(!empty($field['responsive']))
            @include('falcon-cms::admin.falcon-builder.partials.components.fields.responsive-mode', ['menu' => 'cfsel_' . $fieldKey])
        @endif
    </div>
    @if(!empty($field['responsive']))
...
@elseif($ft === 'toggle')
<div>
    @include('falcon-cms::admin.falcon-builder.partials.components.fields.toggle', ['key' => $fieldKey, 'label' => $fieldLabel])
    @if($fieldDesc)<p class="text-[10px] text-slate-400 mt-1">{{ $fieldDesc }}</p>@endif
</div>
...
<div>
    @include('falcon-cms::admin.falcon-builder.partials.components.fields.color', ['key' => $fieldKey, 'label' => $fieldLabel, 'default' => $field['default'] ?? '#000000'])
    @if($fieldDesc)<p class="text-[10px] text-slate-400 mt-1">{{ $fieldDesc }}</p>@endif
</div>
...
<div>
    ...
    <template v-if="editingElement.settings.{{ $dynKey }}">
        <div class="mb-2">
            @include('falcon-cms::admin.falcon-builder.partials.components.elements.custom-dynamic-select', ['dynKey' => $dynKey, 'dynCtx' => 'link'])
        </div>
    </template>
...
@elseif($ft === 'button')
<div>
    @include('falcon-cms::admin.falcon-builder.partials.components.fields.button', ['key' => $fieldKey, 'label' => $fieldLabel, 'placeholder' => $field['placeholder'] ?? 'Click here'])
    @if($fieldDesc)<p class="text-[10px] text-slate-400 mt-1">{{ $fieldDesc }}</p>@endif
</div>
...
@elseif($ft === 'icon')
<div>
    @include('falcon-cms::admin.falcon-builder.partials.components.fields.icon', ['key' => $fieldKey, 'label' => $fieldLabel])
    @if($fieldDesc)<p class="text-[10px] text-slate-400 mt-1">{{ $fieldDesc }}</p>@endif
</div>
...
<div>
    @include('falcon-cms::admin.falcon-builder.partials.components.fields.dimensions', ['key' => $fieldKey, 'label' => $fieldLabel, 'unit' => $field['unit'] ?? 'px'])
    @if($fieldDesc)<p class="text-[10px] text-slate-400 mt-1">{{ $fieldDesc }}</p>@endif
</div>
...
<div>
    ...
    @include('falcon-cms::admin.falcon-builder.partials.components.fields.typography', ['prefix' => $fieldKey])
    @if($fieldDesc)<p class="text-[10px] text-slate-400 mt-1">{{ $fieldDesc }}</p>@endif
</div>
