<x-falcon-cms::layouts.admin title="Categories">
    <x-falcon-cms::admin.delete-modal />
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-[23px] font-normal text-[#1d2327]">Categories</h1>    </div>
                        ...
                        <tr class="{{ $idx % 2 === 0 ? 'bg-[#f6f7f7]' : 'bg-[#fff]' }} group">
                            ...
                            <td class="wp-table-cell align-top">
                                ...
                                <div class="invisible group-hover:visible mt-1 text-[13px] space-x-1">
                                    ...
                                    <a href="{{ url('category/' . $cat->getFullSlugPath()) }}" target="_blank" class="text-[#2271b1]">View</a>
                                </div>
                            </td>
