...
<div class="form-wrap">
    ...
    <div class="form-card">
        ...
        <form action="{{ route('admin.register') }}" method="POST" style="display:flex;flex-direction:column;gap:1rem">
            @csrf
            ...
            <div>
                ...
                <div style="font-size:.72rem;font-weight:700;text-transform:uppercase;min-height:14px;margin-top:4px" id="strength-text"></div>
            </div>
    ...
    <p style="text-align:center;margin-top:1.25rem;font-size:.875rem;color:#6b7280">
        Already have an account? <a href="{{ route('admin.login') }}" class="form-link">Sign in</a>
    </p>
